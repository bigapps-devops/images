...
for file in "$directory"/*; do
  ...
  if [[ -f "$file" ]]; then
    ...
    for folder in $onesignalFolderNames; do
        ...
        convert "images/bw/tr_${filename}" -resize 32x32 -depth 8 rgba:"$destinationFolder/drawable-hdpi/ic_stat_onesignal_default.png"
        convert "images/bw/tr_${filename}" -resize 24x24 -depth 8 rgba:"$destinationFolder/drawable-mdpi/ic_stat_onesignal_default.png"
        convert "images/bw/tr_${filename}" -resize 48x48 -depth 8 rgba:"$destinationFolder/drawable-xhdpi/ic_stat_onesignal_default.png"
        convert "images/bw/tr_${filename}" -resize 72x72 -depth 8 rgba:"$destinationFolder/drawable-xxhdpi/ic_stat_onesignal_default.png"
        convert "images/bw/tr_${filename}" -resize 92x92 -depth 8 rgba:"$destinationFolder/drawable-xxxhdpi/ic_stat_onesignal_default.png"
